...
//Creates a dictionary array to store address information 
...
class TableViewController: UITableViewController {
    ...
    //updates the table with new content from places array
    ...
    //Allows map to centre on users location when they press the "+" button 
    //by resetting the activePlace variable to -1
